...
bl_info = {
    ...
    "version": (1, 2, 19), # Be sure to set minimum version in version.py if nodes have changed!
    "blender": (4, 1, 0),
...
from .handlers import handle_animation, handle_render, handle_startup
from .interface import menu_groups, menu_presets, menu_clipping, menu_working_space, panels_dummy, panels_original, panels_props, sidebar, list_layers
...
files = [
    ...
    menu_presets, menu_groups, menu_clipping, menu_working_space, list_layers,
    panels_dummy, panels_props, panels_original,
    op_report, op_presets, op_nodes, op_scene_settings, op_layers, op_tabs,
    handle_animation, handle_render, handle_startup,
]
