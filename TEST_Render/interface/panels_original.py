...
class OriginalDisplayPanel(bpy.types.Panel):
    ...
    @classmethod
    def poll(self, context):
        return not context.scene.render_raw_scene.enable_RR and bpy.app.version < (5, 0, 0)
...
class OriginalWorkingSpacePanel(bpy.types.Panel):
    bl_label = "Working Space"
    bl_idname = 'RENDER_PT_render_raw_original_working_space'
    bl_parent_id = "RENDER_PT_render_raw"
    bl_options = {'DEFAULT_CLOSED'}
    bl_space_type = 'PROPERTIES'
    bl_region_type = 'WINDOW'
    ...
    def draw(self, context):
        draw_original_working_space(self, context)

class OriginalAdvancedPanel(bpy.types.Panel):
    bl_label = "Advanced"
    bl_idname = 'RENDER_PT_render_raw_original_advanced'
    bl_parent_id = "RENDER_PT_render_raw"
    bl_options = {'DEFAULT_CLOSED'}
    bl_space_type = 'PROPERTIES'
    bl_region_type = 'WINDOW'
...
class OriginalWorkingSpacePanel3DView(bpy.types.Panel):
    bl_label = "Working Space"
    bl_idname = 'RENDER_PT_render_raw_original_working_space_3d_view'
    bl_parent_id = "RENDER_PT_render_raw_color_management_3d_view"
    bl_options = {'DEFAULT_CLOSED'}
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
...
class OriginalAdvancedPanel3DView(bpy.types.Panel):
    bl_label = "Advanced"
    bl_idname = 'RENDER_PT_render_raw_original_advanced_3d_view'
    bl_parent_id = "RENDER_PT_render_raw_color_management_3d_view"
    bl_options = {'DEFAULT_CLOSED'}
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
...
viewport_panels = [
    OriginalWorkingSpacePanel3DView, OriginalWhiteBalancePanel3DView, OriginalDisplayPanel3DView, OriginalCurvePanel3DView,
    OriginalAdvancedPanel3DView,
]

classes = [
    OriginalWorkingSpacePanel, OriginalDisplayPanel, OriginalCurvePanel, OriginalWhiteBalancePanel, OriginalAdvancedPanel,
    OriginalWorkingSpacePanel3DView, OriginalDisplayPanel3DView, OriginalCurvePanel3DView, OriginalWhiteBalancePanel3DView,
    OriginalAdvancedPanel3DView,
]
...
def register():
    ...
    if hasattr(bpy.types, 'RENDER_PT_color_management_working_space'):
        bpy.utils.unregister_class(bpy.types.RENDER_PT_color_management_working_space)
